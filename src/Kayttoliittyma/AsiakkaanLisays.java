...
//  private Label lbTunnus = new Label("Tunnus: ");
...
//      AsLomakekentat.add(tfTunnus, 1, 2);
        ...
        talletaA.setOnAction((event) -> {
            ...
            try {
                ...
                String sukupuoli = CBsukupuoli.getValue().toString();
                //String henkilotunnus = tunnus.getText();
                String asuinalue = tfAsuinalue.getText();

                if (etunimi.isEmpty() || sukunimi.isEmpty() || asuinalue.isEmpty() || sukupuoli.isEmpty()) {
                    Alert virheviesti = new Alert(Alert.AlertType.WARNING);
                    virheviesti.setContentText("Tiedoissa puutteita");
                    virheviesti.show();

                } else {
                    Asiakas uusiAsiakas = new Asiakas(etunimi, sukunimi, sukupuoli, asuinalue);
